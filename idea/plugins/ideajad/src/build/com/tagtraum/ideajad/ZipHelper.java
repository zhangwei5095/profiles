 ...
 * @version 2169.2,  $Id: ZipHelper.java,v 1.2 2003/11/13 21:45:44 hendriks73 Exp $
 */
public final class ZipHelper {
    ...
    /**
     */
    public final static void extract(ZipFile aZipFile, File destinationDir, boolean overwrite, String aPrefix) throws IOException {
        ...
        if (!destinationDir.isDirectory()) {
            throw new IllegalArgumentException("Destinationfile has to be a directory.");
    ...
    /**
     */
    public final static Enumeration entries(ZipFile aZipFile, String aPrefix) {
        return new ZipEntryEnumeration(aZipFile, new ZipEntryPrefixFilter(aPrefix));
    }
    ...
    private static class ZipEntryEnumeration implements Enumeration {
        ...
        public ZipEntryEnumeration(ZipFile aZipFile, ZipEntryFilter anEntryFilter) {
    ...
    private static class ZipEntryPrefixFilter implements ZipEntryFilter {
        ...
        public boolean accept(ZipEntry anEntry) {
            if (prefix != null) {
                return anEntry.getName().startsWith(prefix);
            }
            return true;
        }
